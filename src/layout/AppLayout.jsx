              ...
              <div className="flex w-full items-center gap-3">
                ...
                <div className="flex w-full align-content-center justify-between ">
                  ...
                  <div className="flex flex-row gap-2">
                    <Button className="!flex !gap-2 !rounded-lg !border !border-[var(--border)] !bg-[var(--surface)] !px-4 !py-2 !text-sm !font-medium !text-[var(--text)] hover:!bg-[var(--surface-2)]">
                    ...
                    <Button
                      ...
                      className={`!rounded-lg  !px-4 !py-2 !text-sm !font-semibold ${
                        isScanRunning
                          ? "border border-2 border-[var(--critical)] !bg-[var(--surface-2)] !text-[var(--critical)]"
                          : "border border-2 border-[var(--primary)] !bg-[var(--surface-2)] !text-[var(--primary)]"
                      }`}
                    >
